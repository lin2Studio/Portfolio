...
class Game{
    ...
    public void setAdvantage() {
        ...
        else if  (this.getPlayer1()=='r' && this.getPlayer2()=='s'||
                  this.getPlayer1()=='s' && this.getPlayer2()=='p'||
                  this.getPlayer1()=='p' && this.getPlayer2()=='r'){
            this.Advantage = 1;
        }
        else{
            this.Advantage = -1;
    ...
    public String getDatos() {
    	return "Player1: "+this.getPlayer1()+" Player2: "+this.getPlayer2()+" Advantage: "+this.getAdvantage();
    }
...
class gamesArray{
    ...
    public gamesArray(){
        ...
        for (int i = 0; i < MatchSize; i++) {
            ...
            HaKenBo.setGame();
            Match.add(HaKenBo);
            this.Marcador=this.Marcador+HaKenBo.getAdvantage();
          //System.out.println(HaKenBo.getDatos());				//QUITAR COMENTARIO PARA VER PARTIDAS.
        }
    }
